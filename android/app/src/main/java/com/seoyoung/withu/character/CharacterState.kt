...
enum class CharacterState(val raw: String) {
    ...
    val caption: String
        get() = when (this) {
            ...
            BEACH -> "해변에서 일광욕 🏖️"
            CLOUDY -> "구름 낀 하루 ☁️"
            RAINY_SHELTER -> "우산 쓰고 비 구경 ☔️"
            SNOW_PLAY -> "눈 속에서 신나게 ❄️"
            WALKING_SUNNY -> "햇살 받으며 산책 🚶☀️"
            WALKING_CLOUDY -> "흐린 날 산책 🚶☁️"
            WALKING_RAINY -> "비 오는데 산책 🚶☔"
            WALKING_SNOWY -> "눈길 산책 🚶❄️"
            RUNNING_SUNNY -> "햇살 아래 달리기 🏃☀️"
            RUNNING_CLOUDY -> "흐린 날 달리기 🏃☁️"
            RUNNING_RAINY -> "비 맞으며 달리기 🏃☔"
            RUNNING_SNOWY -> "눈 속 달리기 🏃❄️"
            CYCLING_SUNNY -> "햇살 자전거 🚴☀️"
            CYCLING_CLOUDY -> "흐린 날 자전거 🚴☁️"
            CYCLING_RAINY -> "비 오는데 자전거 🚴☔"
            CYCLING_SNOWY -> "눈 속 자전거 🚴❄️"
        }
